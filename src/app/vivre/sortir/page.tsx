      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#F5ECD7] to-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-playfair)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#2C1810] leading-tight mb-6">
            Sortir à Madrid —{" "}
            <span className="italic text-[#C8614A]">culture, parcs et nuits longues</span>
          </h1>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-[#C8614A]/10 text-[#C8614A] text-xs font-semibold">
      ...
      <section className="py-20 px-6 bg-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="font-[family-name:var(--font-playfair)] font-bold text-[#2C1810] text-lg mb-2">
                Parque del Retiro
              </p>
      ...
      <section className="py-20 px-6 bg-[#F5ECD7]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-[#EDE0C8] rounded-2xl p-6">
            <p className="font-semibold text-[#2C1810] mb-2">La suite logique du Rastro</p>
            <p className="text-[#5a3e35] text-sm leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              ...
              <p className="font-semibold text-[#2C1810] mb-1">Huertas</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
          ...
          <div className="bg-[#EDE0C8] rounded-2xl p-6">
            <p className="font-semibold text-[#2C1810] mb-2">Les terrazas — la culture de la terrasse</p>
            <p className="text-[#5a3e35] text-sm leading-relaxed">
