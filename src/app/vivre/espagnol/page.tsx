  ...
  const schema = [
    {
      ...
      "@type": "Article",
      headline: "Apprendre l'espagnol à Madrid : les vraies options",
      description: "EOI à ~250€ le quadrimestre, académies privées, intercambios gratuits. Tout pour progresser vite en espagnol à Madrid.",
      ...
      url: "https://madrid-et-toi.com/vivre/espagnol",
      mainEntityOfPage: { "@type": "WebPage", "@id": "https://madrid-et-toi.com/vivre/espagnol" },
      inLanguage: "fr-FR",
    },
    {
      "@context": "https://schema.org",
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Apprendre l'espagnol", item: "https://madrid-et-toi.com/vivre/espagnol" },
      ],
    },
  ];
  return (
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#FFFBF5] to-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-heading)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#33251E] leading-tight mb-6">
            ...
            <span className="not-italic font-bold text-[#F0552F]">les vraies options</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-2">Ce qui est bien</p>
              <ul className="space-y-2">
                <li className="flex gap-2 items-start">
                  <span className="text-[#F2A65A] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Diplôme officiel reconnu à l&apos;issue de chaque niveau</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="text-[#F2A65A] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Cours du soir adaptés aux actifs</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="text-[#F2A65A] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Niveaux A1 à C1, progression structurée</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="text-[#F2A65A] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Prix imbattable : ~250 €/quadrimestre</span>
                </li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-2">Le point de vigilance</p>
              <ul className="space-y-2">
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 text-[#F0552F] mt-0.5 font-bold">✕</span>
                  <span className="text-[#33251E] text-sm">Très demandées — liste d&apos;attente fréquente</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 text-[#F0552F] mt-0.5 font-bold">✕</span>
                  <span className="text-[#33251E] text-sm">Inscription en juin pour la rentrée de septembre</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 text-[#F0552F] mt-0.5 font-bold">✕</span>
                  <span className="text-[#33251E] text-sm">Pas de cours intensifs — rythme plus lent</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-[#FBEBDD] rounded-2xl p-6">
            <p className="font-semibold text-[#33251E] mb-2">Le conseil pratique</p>
      ...
      <section className="py-20 px-6 bg-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Inhispania</p>
              <p className="font-semibold text-[#33251E] mb-2">Cours intensifs en petits groupes</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">TANDEM Madrid</p>
              <p className="font-semibold text-[#33251E] mb-2">Reconnue par l&apos;Instituto Cervantes</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Eureka Madrid</p>
              <p className="font-semibold text-[#33251E] mb-2">Fondée en 1988 — spécialiste ELE</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Club de Español</p>
              <p className="font-semibold text-[#33251E] mb-2">Cours du soir accessibles</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <p className="font-semibold text-[#33251E] text-sm mb-2">Fourchette de prix académies privées</p>
            <p className="text-[#33251E] text-sm leading-relaxed">
      ...
      <section className="py-20 px-6 bg-[#FFFBF5]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-3">Où en trouver</p>
              <ul className="space-y-2">
                <li className="flex gap-2 items-start">
                  <span className="text-[#F0552F] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Meetup — groupes d&apos;intercambio actifs à Madrid</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="text-[#F0552F] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Groupes Facebook dédiés aux expats francophones</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="text-[#F0552F] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Application Tandem — format digital en parallèle</span>
                </li>
                <li className="flex gap-2 items-start">
                  <span className="text-[#F0552F] font-bold flex-shrink-0">—</span>
                  <span className="text-[#33251E] text-sm">Application HelloTalk — même principe</span>
                </li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-3">Les quartiers les plus actifs</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                ,{" "}
                <Link href="/logement/quartiers/chueca" className="text-[#F0552F] underline underline-offset-2 hover:text-[#CC4828] transition-colors">
                  Chueca
                </Link>{" "}
                et{" "}
                <Link href="/logement/quartiers/lavapies" className="text-[#F0552F] underline underline-offset-2 hover:text-[#CC4828] transition-colors">
                  Lavapiés
                </Link>
          ...
          <div className="bg-[#FBEBDD] rounded-2xl p-6">
            <p className="font-semibold text-[#33251E] mb-2">Le format type d&apos;un intercambio</p>
            <p className="text-[#33251E] text-sm leading-relaxed">
      ...
      <section className="py-20 px-6 bg-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Duolingo</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Babbel</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Pimsleur</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-1">Anki</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
          ...
          <div className="bg-white rounded-3xl shadow-md overflow-hidden">
            <div className="px-6 py-4 bg-[#241813]">
              <p className="text-[#FFC24B] font-semibold">Immersion quotidienne — les réflexes à prendre dès le premier jour</p>
            </div>
            <div className="divide-y divide-[#FBEBDD]">
              <div className="px-6 py-4 flex items-start gap-4">
                <div className="flex-shrink-0 w-5 h-5 rounded border-2 border-[#F0552F] mt-0.5" />
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Passer son téléphone en espagnol</p>
                  <p className="text-[#33251E]/70 text-xs mt-0.5">Quelques minutes de friction, des centaines de mots vus chaque jour</p>
                </div>
              </div>
              <div className="px-6 py-4 flex items-start gap-4">
                <div className="flex-shrink-0 w-5 h-5 rounded border-2 border-[#F0552F] mt-0.5" />
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Regarder des séries en VO espagnole</p>
                  <p className="text-[#33251E]/70 text-xs mt-0.5">Sous-titres en espagnol, pas en français — l&apos;oreille s&apos;adapte en quelques semaines</p>
                </div>
              </div>
              <div className="px-6 py-4 flex items-start gap-4">
                <div className="flex-shrink-0 w-5 h-5 rounded border-2 border-[#F0552F] mt-0.5" />
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Commander en espagnol dès le premier jour</p>
                  <p className="text-[#33251E]/70 text-xs mt-0.5">Même si c&apos;est laborieux — les Madrilènes sont patients et encourageants</p>
                </div>
              </div>
              <div className="px-6 py-4 flex items-start gap-4">
                <div className="flex-shrink-0 w-5 h-5 rounded border-2 border-[#F0552F] mt-0.5" />
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Écouter des podcasts en espagnol</p>
                  <p className="text-[#33251E]/70 text-xs mt-0.5">Dans les transports, en faisant la cuisine — le cerveau travaille en arrière-plan</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-[#241813]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white/10 rounded-2xl p-5 mb-8">
            <p className="text-[#FFC24B] font-semibold text-sm uppercase tracking-widest mb-2">Diplôme de l&apos;Instituto Cervantes</p>
