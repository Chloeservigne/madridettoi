    ...
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="py-20 px-6 bg-[#fbfaf6]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-[#f2f0e9] rounded-2xl p-6">
            <p className="font-semibold text-[#171712] mb-2">Le conseil pratique</p>
      ...
      <section className="py-20 px-6 bg-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <p className="font-semibold text-[#171712] text-sm mb-2">Fourchette de prix académies privées</p>
            <p className="text-[#171712] text-sm leading-relaxed">
      ...
      <section className="py-20 px-6 bg-[#fbfaf6]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-3">Les quartiers les plus actifs</p>
              <p className="text-[#171712] text-sm leading-relaxed">
          ...
          <div className="bg-[#f2f0e9] rounded-2xl p-6">
            <p className="font-semibold text-[#171712] mb-2">Le format type d&apos;un intercambio</p>
            <p className="text-[#171712] text-sm leading-relaxed">
