        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 bg-white rounded-3xl shadow-md overflow-hidden">
            ...
            <div className="divide-y divide-[#f2f0e9]">
              ...
              <div className="px-6 py-4 flex justify-between items-center">
                <div>
                  <p className="font-semibold text-[#171712] text-sm">Abono General (26–64 ans)</p>
                  <p className="text-[#171712]/60 text-xs mt-0.5">
                    Prix subventionné (-40%) · tarif plein ~54 €/mois
                  </p>
                </div>
                <span className="font-bold text-[#171712] text-lg">32,70 €/mois</span>
              </div>
              <div className="px-6 py-4 flex justify-between items-center">
                <div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-2">Horaires</p>
              <p className="text-[#171712] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-2">Tarifs à l&apos;unité</p>
              <p className="text-[#171712] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-2">Supplément aéroport</p>
              <p className="text-[#171712] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-2">Application</p>
              <p className="text-[#171712] text-sm leading-relaxed">
          ...
          <div className="bg-white rounded-3xl shadow-md overflow-hidden">
            ...
            <div className="divide-y divide-[#f2f0e9]">
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#171712] text-sm">Cercanías C-1 / C-10</p>
                ...
                <div className="text-right">
                  <p className="text-[#171712] text-sm">~25–30 min</p>
                  <p className="text-[#171712]/60 text-xs">depuis Chamartín</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#171712] text-sm">Métro L8</p>
                  <p className="text-[#171712]/70 text-xs mt-1">T1–T2–T3 (pas T4)</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#171712]">4,50 €</p>
                  <p className="text-[#171712]/60 text-xs">1,50 € + suppl. 3 € (gratuit Abono)</p>
                </div>
                <div className="text-right">
                  <p className="text-[#171712] text-sm">~30–40 min</p>
                  <p className="text-[#171712]/60 text-xs">depuis Nuevos Ministerios</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#171712] text-sm">Bus Exprés 203 (EMT)</p>
                  <p className="text-[#171712]/70 text-xs mt-1">T1, T2, T4 — 24h/24</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#171712]">5,00 €</p>
                  <p className="text-[#171712]/60 text-xs">à bord (carte ou espèces)</p>
                </div>
                <div className="text-right">
                  <p className="text-[#171712] text-sm">~30–40 min</p>
                  <p className="text-[#171712]/60 text-xs">Atocha — Cibeles</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#171712] text-sm">Taxi</p>
                  <p className="text-[#171712]/70 text-xs mt-1">Tarif fixe officiel</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#171712]">33 €</p>
                  <p className="text-[#171712]/60 text-xs">forfait aéroport–M-30, 24h/24</p>
                </div>
                <div className="text-right">
                  <p className="text-[#171712] text-sm">~20–40 min</p>
                  <p className="text-[#171712]/60 text-xs">selon trafic</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#171712] text-sm">VTC (Uber / Cabify)</p>
                  <p className="text-[#171712]/70 text-xs mt-1">Tarif dynamique</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#171712]">25–35 €</p>
                  <p className="text-[#171712]/60 text-xs">variable selon demande</p>
                </div>
                <div className="text-right">
                  <p className="text-[#171712] text-sm">~20–40 min</p>
                  <p className="text-[#171712]/60 text-xs">selon trafic</p>
