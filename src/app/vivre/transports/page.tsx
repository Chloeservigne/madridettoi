  ...
  const schema = [
    {
      ...
      "@type": "Article",
      headline: "Transports à Madrid : métro, bus, Cercanías, taxi",
      description:
        "L'Abono Transportes à 32,70€/mois, le métro (303 stations, 6h–1h30), les búhos nocturnes, BiciMAD, le taxi et rejoindre l'aéroport. Tout pour se déplacer à Madrid sans voiture.",
      ...
      url: "https://madrid-et-toi.com/vivre/transports",
      mainEntityOfPage: { "@type": "WebPage", "@id": "https://madrid-et-toi.com/vivre/transports" },
      inLanguage: "fr-FR",
    },
    {
      "@context": "https://schema.org",
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Transports", item: "https://madrid-et-toi.com/vivre/transports" },
      ],
    },
  ];
      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#FFFBF5] to-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-heading)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#33251E] leading-tight mb-6">
            ...
            <span className="not-italic font-bold text-[#F0552F]">sans voiture, sans galère</span>
          </h1>
          ...
          <div className="mt-8 bg-white rounded-3xl shadow-md overflow-hidden">
            ...
            <div className="divide-y divide-[#FBEBDD]">
              <div className="px-6 py-4 flex justify-between items-center">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Abono Joven (15–25 ans)</p>
                  <p className="text-[#33251E]/60 text-xs mt-0.5">Avec justificatif d&apos;âge</p>
                </div>
                <span className="font-bold text-[#F0552F] text-lg">10,00 €/mois</span>
              </div>
              <div className="px-6 py-4 flex justify-between items-center">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Abono General (26–64 ans)</p>
                  <p className="text-[#33251E]/60 text-xs mt-0.5">
                    Prix subventionné (-40%) · tarif plein ~54 €/mois
                  </p>
                </div>
                <span className="font-bold text-[#33251E] text-lg">32,70 €/mois</span>
              </div>
              <div className="px-6 py-4 flex justify-between items-center">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Abono +65 ans</p>
                  <p className="text-[#33251E]/60 text-xs mt-0.5">Sur présentation de la tarjeta</p>
                </div>
                <span className="font-bold text-[#F2A65A] text-lg">Gratuit</span>
              </div>
            </div>
          </div>

          <div className="mt-4 bg-[#FFC24B]/10 border border-[#FFC24B]/30 rounded-2xl px-5 py-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-2">Horaires</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-2">Tarifs à l&apos;unité</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-2">Supplément aéroport</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#33251E] text-sm mb-2">Application</p>
              <p className="text-[#33251E] text-sm leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white/10 rounded-2xl p-6">
              ...
              <p className="text-[#F6E7D9]/80 text-sm leading-relaxed mt-3">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-md overflow-hidden">
            <div className="px-6 py-4 bg-[#241813]">
              <p className="text-[#FFC24B] font-semibold">Comparatif centre-ville ↔ aéroport</p>
            </div>
            <div className="divide-y divide-[#FBEBDD]">
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Cercanías C-1 / C-10</p>
                  <p className="text-[#33251E]/70 text-xs mt-1">T4 uniquement (gare en sous-sol)</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#F2A65A]">Inclus Abono</p>
                  <p className="text-[#33251E]/60 text-xs">ou ~2,60 € sans</p>
                </div>
                <div className="text-right">
                  <p className="text-[#33251E] text-sm">~25–30 min</p>
                  <p className="text-[#33251E]/60 text-xs">depuis Chamartín</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Métro L8</p>
                  <p className="text-[#33251E]/70 text-xs mt-1">T1–T2–T3 (pas T4)</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#33251E]">4,50 €</p>
                  <p className="text-[#33251E]/60 text-xs">1,50 € + suppl. 3 € (gratuit Abono)</p>
                </div>
                <div className="text-right">
                  <p className="text-[#33251E] text-sm">~30–40 min</p>
                  <p className="text-[#33251E]/60 text-xs">depuis Nuevos Ministerios</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Bus Exprés 203 (EMT)</p>
                  <p className="text-[#33251E]/70 text-xs mt-1">T1, T2, T4 — 24h/24</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#33251E]">5,00 €</p>
                  <p className="text-[#33251E]/60 text-xs">à bord (carte ou espèces)</p>
                </div>
                <div className="text-right">
                  <p className="text-[#33251E] text-sm">~30–40 min</p>
                  <p className="text-[#33251E]/60 text-xs">Atocha — Cibeles</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">Taxi</p>
                  <p className="text-[#33251E]/70 text-xs mt-1">Tarif fixe officiel</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#33251E]">33 €</p>
                  <p className="text-[#33251E]/60 text-xs">forfait aéroport–M-30, 24h/24</p>
                </div>
                <div className="text-right">
                  <p className="text-[#33251E] text-sm">~20–40 min</p>
                  <p className="text-[#33251E]/60 text-xs">selon trafic</p>
                </div>
              </div>
              <div className="px-6 py-5 grid grid-cols-3 gap-4">
                <div>
                  <p className="font-semibold text-[#33251E] text-sm">VTC (Uber / Cabify)</p>
                  <p className="text-[#33251E]/70 text-xs mt-1">Tarif dynamique</p>
                </div>
                <div className="text-center">
                  <p className="font-bold text-[#33251E]">25–35 €</p>
                  <p className="text-[#33251E]/60 text-xs">variable selon demande</p>
                </div>
                <div className="text-right">
                  <p className="text-[#33251E] text-sm">~20–40 min</p>
                  <p className="text-[#33251E]/60 text-xs">selon trafic</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#F0552F] text-xs font-semibold mt-4 block hover:underline"
              >
                bicimad.com ↗
              </a>
            </div>
