    ...
    <div className="min-h-screen font-[family-name:var(--font-dm-sans)]">
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#F5ECD7] to-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-playfair)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#2C1810] leading-tight mb-6">
            La santé à Madrid —{" "}
            <span className="italic text-[#C8614A]">médecin, urgences, mutuelle</span>
          </h1>
          ...
          <div className="mt-8 bg-[#EDE0C8] rounded-2xl p-6">
            ...
            <ul className="space-y-2">
              <li className="flex gap-2 items-start">
                ...
                <span className="text-sm text-[#5a3e35]">
                  Ton{" "}
                  <Link
                    href="/papiers/nie"
                    className="text-[#C8614A] underline underline-offset-2 hover:text-[#A84D3A] transition-colors"
            ...
            <p className="text-[#5a3e35] text-sm mt-4">
      ...
      <section className="py-20 px-6 bg-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#2C1810] text-sm mb-2">Ce qu&apos;elle ne couvre pas</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div className="bg-white/10 rounded-2xl p-6">
              ...
              <p className="text-[#F5ECD7]/50 text-xs mt-3">
      ...
      <section className="py-20 px-6 bg-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">
                Sanitas
              </p>
