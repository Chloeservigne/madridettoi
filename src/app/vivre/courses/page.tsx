    ...
    <div className="min-h-screen font-[family-name:var(--font-dm-sans)]">
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#F5ECD7] to-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-playfair)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#2C1810] leading-tight mb-6">
            Tout savoir sur{" "}
            <span className="italic text-[#C8614A]">les courses à Madrid</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              ...
              <p className="text-[#5a3e35]/70 text-xs mb-2">
                <Link
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              ...
              <p className="text-[#5a3e35]/70 text-xs mb-2">Sol / Centro</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
      ...
      <section className="py-20 px-6 bg-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-[#E8A838]/10 border border-[#E8A838]/30 rounded-2xl px-5 py-4">
            <p className="text-[#5a3e35] text-sm leading-relaxed">
