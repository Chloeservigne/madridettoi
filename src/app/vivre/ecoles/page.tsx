            ...
            {mutuelles.map((option) => (
              <div key={option.nom} className="bg-white rounded-2xl p-5 shadow-sm">
                <div className="flex items-start justify-between gap-4 mb-2">
                  <p className="font-semibold text-[#171712]">{option.nom}</p>
      ...
      <section className="py-20 px-6 bg-[#fbfaf6]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-1">Prérequis</p>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-1">L&apos;école de secteur</p>
              <p className="text-[#171712]/70 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#171712] text-sm mb-1">Calendrier</p>
              <p className="text-[#171712]/70 text-sm leading-relaxed">
