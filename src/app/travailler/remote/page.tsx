  ...
  const schema = [
    {
      ...
      "@type": "Article",
      headline: "Peut-on travailler en remote depuis Madrid ?",
      description:
        "C'est légal ? Quel visa ? Quelles implications fiscales ? Tout ce qu'il faut savoir pour travailler à distance depuis Madrid.",
      ...
      url: "https://madrid-et-toi.com/travailler/remote",
      mainEntityOfPage: { "@type": "WebPage", "@id": "https://madrid-et-toi.com/travailler/remote" },
      inLanguage: "fr-FR",
    },
    {
      "@context": "https://schema.org",
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Remote", item: "https://madrid-et-toi.com/travailler/remote" },
      ],
    },
  ];
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#FFFBF5] to-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-heading)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#33251E] leading-tight mb-6">
            Peut-on travailler{" "}
            <span className="not-italic font-bold text-[#F0552F]">en remote depuis Madrid&nbsp;?</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white/10 rounded-2xl p-5">
              ...
              <p className="text-[#F6E7D9]/80 text-sm leading-relaxed">
                Le statut d&apos;
                <Link href="/travailler/freelance" className="text-[#FFC24B] underline underline-offset-2 hover:opacity-80 transition-opacity">
                  autónomo
                </Link>{" "}
