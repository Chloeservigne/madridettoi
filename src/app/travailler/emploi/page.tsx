        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-10">
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              ...
              <p className="text-[#5a3e35] text-sm">SMI brut mensuel 2026<br />(+3,1 % vs 2025)</p>
            </div>
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="font-[family-name:var(--font-playfair)] text-3xl font-bold text-[#C8614A] mb-2">3 200 €</p>
              <p className="text-[#5a3e35] text-sm">Salaire moyen brut<br />à Madrid</p>
            </div>
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="font-[family-name:var(--font-playfair)] text-3xl font-bold text-[#C8614A] mb-2">25 %</p>
              <p className="text-[#5a3e35] text-sm">Des offres qualifiées<br />du pays sont à Madrid</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Tech & Numérique</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Finance & Banque</p>
              <p className="text-[#5a3e35] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Support client multilingue</p>
              <p className="text-[#5a3e35] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Commercial & Business Development</p>
              <p className="text-[#5a3e35] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Enseignement & FLE</p>
              <p className="text-[#5a3e35] leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#2C1810] mb-2">InfoJobs</p>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#2C1810] mb-2">LinkedIn</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#2C1810] mb-2">Le réseau</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="font-semibold text-[#2C1810] mb-2">Agences de recrutement</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 mb-10">
            <div className="bg-white/10 rounded-2xl p-5">
              <p className="text-[#E8A838] font-semibold text-sm uppercase tracking-widest mb-2">L&apos;espagnol est non-négociable</p>
            ...
            <div className="bg-white/10 rounded-2xl p-5">
              <p className="text-[#E8A838] font-semibold text-sm uppercase tracking-widest mb-2">Les salaires sont plus bas qu&apos;en France</p>
              <p className="text-[#F5ECD7]/80 text-sm leading-relaxed">
            ...
            <div className="bg-white/10 rounded-2xl p-5">
              <p className="text-[#E8A838] font-semibold text-sm uppercase tracking-widest mb-2">Le CV espagnol est différent</p>
              <p className="text-[#F5ECD7]/80 text-sm leading-relaxed">
