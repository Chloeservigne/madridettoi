        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="font-[family-name:var(--font-heading)] text-3xl font-bold text-[#F0552F] mb-2">130 000</p>
              <p className="text-[#33251E] text-sm">Emplois créés par des entreprises françaises dans la région de Madrid</p>
            </div>
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="font-[family-name:var(--font-heading)] text-3xl font-bold text-[#F0552F] mb-2">400+</p>
              <p className="text-[#33251E] text-sm">Entreprises membres de la Chambre Franco-Espagnole (CCIFE)</p>
            </div>
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="font-[family-name:var(--font-heading)] text-3xl font-bold text-[#F0552F] mb-2">n°1</p>
              <p className="text-[#33251E] text-sm">Communauté autonome qui reçoit le plus d&apos;investissements directs français</p>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-4">Distribution & Retail</p>
              <div className="space-y-5">
                <div>
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Decathlon España</p>
                    <a
                      href="https://www.decathlon.es/es/rrhh"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#F0552F] text-xs font-semibold whitespace-nowrap hover:underline"
                    >
                      Offres →
                    </a>
                  </div>
                  <p className="text-[#F2A65A] text-xs mb-2">Siège : San Sebastián de los Reyes (nord Madrid, 28702)</p>
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Carrefour España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Siège : Boadilla del Monte (ouest Madrid)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Leroy Merlin España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Siège : Alcobendas (nord Madrid)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            {/* Aéro / Défense */}
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-4">Aéronautique, Défense & Industrie</p>
              <div className="space-y-5">
                <div>
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Airbus España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Site principal : Paseo John Lennon s/n, Getafe (sud Madrid, 28906)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Thales España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Bureaux : Parque Norte, Calle Serrano Galvache 56, Madrid 28033 — Centre de production : Tres Cantos (nord Madrid)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Safran España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Implantation dans la région de Madrid (équipements aéronautiques)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <p className="font-semibold text-[#33251E] mb-1">Schneider Electric & Saint-Gobain</p>
                  <p className="text-[#F2A65A] text-xs mb-2">Bureaux et opérations à Madrid</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-4">Beauté, Télécom, Énergie & Auto</p>
              <div className="space-y-5">
                <div>
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">L&apos;Oréal España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Siège : Calle Alcalá 546, Madrid (nouveau siège inauguré récemment)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Orange España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Siège : Parque Empresarial La Finca, Pozuelo de Alarcón (ouest Madrid, 28223)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Renault España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Siège espagnol : Avenida de Europa Business Park, Alcobendas (nord Madrid)</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
                ...
                <div className="border-t border-[#FBEBDD] pt-5">
                  <div className="flex items-start justify-between gap-4 mb-1">
                    <p className="font-semibold text-[#33251E]">Air Liquide España</p>
                    <a
                  ...
                  <p className="text-[#F2A65A] text-xs mb-2">Bureaux à Madrid</p>
                  <p className="text-[#33251E] text-sm leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-2">Conditions</p>
              <ul className="text-[#33251E] text-sm leading-relaxed space-y-1">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#F0552F] font-semibold uppercase tracking-widest text-sm mb-2">Points d&apos;attention</p>
              <ul className="text-[#33251E] text-sm leading-relaxed space-y-1">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            <div className="bg-white/10 rounded-2xl p-5">
              <p className="text-[#FFC24B] font-semibold text-sm uppercase tracking-widest mb-2">La Chambre Franco-Espagnole</p>
              <p className="text-[#F6E7D9]/80 text-sm leading-relaxed">
                ...
                en face à face.{" "}
                <a href="https://www.lachambre.es" target="_blank" rel="noopener noreferrer" className="text-[#FFC24B] underline underline-offset-2 hover:opacity-80 transition-opacity">lachambre.es</a>
              </p>
            </div>
            <div className="bg-white/10 rounded-2xl p-5">
              <p className="text-[#FFC24B] font-semibold text-sm uppercase tracking-widest mb-2">French Tech Madrid</p>
              <p className="text-[#F6E7D9]/80 text-sm leading-relaxed">
