      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#F5ECD7] to-[#EDE0C8]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-playfair)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#2C1810] leading-tight mb-6">
            Devenir{" "}
            <span className="italic text-[#C8614A]">autónomo en Espagne</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-5">
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#C8614A] flex items-center justify-center text-white font-bold text-sm">
                1
              </div>
              <div>
          ...
          <div className="mt-8 bg-[#C8614A]/10 border border-[#C8614A]/20 rounded-2xl p-5">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#EDE0C8]">
                  <th className="text-left px-4 py-3 rounded-tl-xl text-[#2C1810] font-semibold">Revenus nets / mois</th>
                  <th className="text-right px-4 py-3 rounded-tr-xl text-[#2C1810] font-semibold">Cotisation / mois</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#EDE0C8]">
                <tr className="bg-white">
                  <td className="px-4 py-3 text-[#5a3e35]">Moins de 670 €</td>
                  <td className="px-4 py-3 text-right text-[#5a3e35] font-medium">~205 €</td>
                </tr>
                <tr className="bg-white/60">
                  <td className="px-4 py-3 text-[#5a3e35]">670 € – 1 300 €</td>
                  <td className="px-4 py-3 text-right text-[#5a3e35] font-medium">~260 – 290 €</td>
                </tr>
                <tr className="bg-white">
                  <td className="px-4 py-3 text-[#5a3e35]">1 300 € – 1 700 €</td>
                  <td className="px-4 py-3 text-right text-[#5a3e35] font-medium">~310 – 350 €</td>
                </tr>
                <tr className="bg-white/60">
                  <td className="px-4 py-3 text-[#5a3e35]">1 700 € – 2 500 €</td>
                  <td className="px-4 py-3 text-right text-[#5a3e35] font-medium">~370 – 425 €</td>
                </tr>
                <tr className="bg-white">
                  <td className="px-4 py-3 text-[#5a3e35]">2 500 € – 6 000 €</td>
                  <td className="px-4 py-3 text-right text-[#5a3e35] font-medium">~470 – 530 €</td>
                </tr>
                <tr className="bg-white/60">
                  <td className="px-4 py-3 rounded-b-xl text-[#5a3e35]">Plus de 6 000 €</td>
                  <td className="px-4 py-3 rounded-b-xl text-right text-[#5a3e35] font-medium">~590 – 605 €</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-[#5a3e35]/70 text-xs mt-3">
            Montants indicatifs basés sur le barème RETA 2025–2026. Source : Seguridad Social / seg-social.es
          </p>
          <p className="text-[#5a3e35] leading-relaxed text-base mt-6">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">IVA (TVA)</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">IRPF (impôt sur le revenu)</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Résumé annuel</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <p className="text-[#C8614A] font-semibold uppercase tracking-widest text-sm mb-2">Clients français</p>
              <p className="text-[#5a3e35] text-sm leading-relaxed">
