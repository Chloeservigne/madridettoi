        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="font-semibold text-[#171712] text-lg mb-2">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#f2f0e9]">
                  <th className="text-left px-4 py-3 rounded-tl-xl text-[#171712] font-semibold">Revenus nets / mois</th>
                  <th className="text-right px-4 py-3 rounded-tr-xl text-[#171712] font-semibold">Cotisation / mois</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#f2f0e9]">
                <tr className="bg-white">
                  <td className="px-4 py-3 text-[#171712]">Moins de 670 €</td>
                  <td className="px-4 py-3 text-right text-[#171712] font-medium">~205 €</td>
                </tr>
                <tr className="bg-white/60">
                  <td className="px-4 py-3 text-[#171712]">670 € – 1 300 €</td>
                  <td className="px-4 py-3 text-right text-[#171712] font-medium">~260 – 290 €</td>
                </tr>
                <tr className="bg-white">
                  <td className="px-4 py-3 text-[#171712]">1 300 € – 1 700 €</td>
                  <td className="px-4 py-3 text-right text-[#171712] font-medium">~310 – 350 €</td>
                </tr>
                <tr className="bg-white/60">
                  <td className="px-4 py-3 text-[#171712]">1 700 € – 2 500 €</td>
                  <td className="px-4 py-3 text-right text-[#171712] font-medium">~370 – 425 €</td>
                </tr>
                <tr className="bg-white">
                  <td className="px-4 py-3 text-[#171712]">2 500 € – 6 000 €</td>
                  <td className="px-4 py-3 text-right text-[#171712] font-medium">~470 – 530 €</td>
                </tr>
                <tr className="bg-white/60">
                  <td className="px-4 py-3 rounded-b-xl text-[#171712]">Plus de 6 000 €</td>
                  <td className="px-4 py-3 rounded-b-xl text-right text-[#171712] font-medium">~590 – 605 €</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-[#171712]/70 text-xs mt-3">
            Montants indicatifs basés sur le barème RETA 2025–2026. Source : Seguridad Social / seg-social.es
          </p>
          <p className="text-[#171712] leading-relaxed text-base mt-6">
