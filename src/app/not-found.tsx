    ...
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="pt-32 md:pt-40 pb-24 px-6 min-h-screen flex items-center bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9]">
        <div className="max-w-2xl mx-auto text-center">
          <p className="font-[family-name:var(--font-body)] text-8xl font-bold text-[#1fa971]/20 mb-2">
            404
          </p>
          <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl font-extrabold text-[#171712] mb-6">
            Cette page s&apos;est{" "}
            <span className="not-italic font-bold text-[#1fa971]">perdue en chemin</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/"
              className="px-6 py-3 rounded-full bg-[#1fa971] text-white font-semibold hover:bg-[#178a5d] transition-colors"
            >
              Retour à l&apos;accueil
            </Link>
            <Link
              href="/logement"
              className="px-6 py-3 rounded-full border border-[#171712]/20 text-[#171712] font-semibold hover:border-[#1fa971] hover:text-[#1fa971] transition-colors"
            >
              Trouver un logement
            </Link>
          </div>
