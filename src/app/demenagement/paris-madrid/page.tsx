    ...
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#FFFBF5] to-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <span className="px-3 py-1.5 rounded-full bg-[#F0552F]/10 text-[#F0552F] text-sm font-semibold">~1 250 km</span>
            <span className="px-3 py-1.5 rounded-full bg-[#F0552F]/10 text-[#F0552F] text-sm font-semibold">12–13h de route</span>
            <span className="px-3 py-1.5 rounded-full bg-[#F0552F]/10 text-[#F0552F] text-sm font-semibold">Guide pratique</span>
          </div>
      ...
      <section className="py-20 px-6 bg-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <ul className="space-y-3 text-[#33251E]">
            <li className="flex items-start gap-3">
              <span className="text-[#F0552F] mt-0.5 font-bold flex-shrink-0">—</span>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white/10 rounded-2xl p-5">
              <p className="text-[#FFC24B] font-semibold text-sm uppercase tracking-widest mb-3">
                Résiliations
              </p>
              <ul className="space-y-2 text-[#F6E7D9]/80 text-sm leading-relaxed">
