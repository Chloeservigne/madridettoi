...
const steps = [
  ...
  },
  {
    ...
    content:
      <>Le marché a évolué : un studio dans un quartier central comme <Link href="/logement/quartiers" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">Malasaña ou Chueca</Link> se loue aujourd&apos;hui entre 900 et 1 200 €/mois. Un appartement d&apos;une chambre entre 1 000 et 1 500 €. Lavapiés et Vallecas restent plus abordables. La caution représente généralement 1 à 2 mois de loyer. Pour les fourchettes détaillées par quartier, voir le <Link href="/se-decider/budget" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">guide budget</Link>.</>,
  },
  {
    number: "03",
    title: "Les documents demandés",
    content:
      <>Les propriétaires demandent souvent : un contrat de travail espagnol ou une preuve de revenus, les 3 dernières fiches de paie, et parfois un garant. Si tu arrives sans emploi local, certains acceptent une garantie bancaire ou plusieurs mois de loyer d&apos;avance. <Link href="/papiers/nie" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">Le NIE</Link> est souvent demandé pour signer.</>,
  },
  {
    number: "04",
      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#171712] leading-tight mb-6">
            ...
            <span className="not-italic font-bold text-[#d6442a]">depuis la France&nbsp;?</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          {steps.map((step) => (
            <div key={step.number} className="flex gap-6">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#d6442a]/10 flex items-center justify-center">
                <span className="font-[family-name:var(--font-body)] text-[#d6442a] font-bold text-sm">
                  {step.number}
                </span>
              </div>
              <div>
      ...
      <section className="py-16 px-6 bg-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/logement/quartiers" className="px-4 py-2 rounded-full bg-white shadow-md text-[#171712] text-sm hover:border-[#d6442a] hover:text-[#d6442a] transition-colors">
            ...
            <Link href="/papiers/secu" className="px-4 py-2 rounded-full bg-white shadow-md text-[#171712] text-sm hover:border-[#d6442a] hover:text-[#d6442a] transition-colors">
