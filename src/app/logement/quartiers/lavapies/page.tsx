    ...
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#af3722] font-semibold tracking-widest uppercase text-sm mb-4">🌍 Quartier Lavapiés</p>
          <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#171712] leading-tight mb-6">
            Lavapiés —{" "}
            <span className="not-italic font-bold text-[#d6442a]">multiculturel, alternatif, abordable</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">Multiculturel & alternatif</span>
            <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">💶 800 – 1 100 € / mois</span>
            <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">Profils créatifs · Budget serré</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="text-[#d6442a] font-bold text-xl font-[family-name:var(--font-body)]">700 – 900 €</p>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="text-[#d6442a] font-bold text-xl font-[family-name:var(--font-body)]">400 – 580 €</p>
