    ...
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-[#FFFBF5] to-[#FBEBDD]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#F2A65A] font-semibold tracking-widest uppercase text-sm mb-4">💎 Quartier Salamanca</p>
          <h1 className="font-[family-name:var(--font-heading)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#33251E] leading-tight mb-6">
            Salamanca —{" "}
            <span className="not-italic font-bold text-[#F0552F]">bourgeois, calme, haut de gamme</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            <span className="px-3 py-1.5 rounded-full bg-[#F0552F]/10 text-[#F0552F] text-sm font-semibold">Bourgeois & élégant</span>
            <span className="px-3 py-1.5 rounded-full bg-[#F0552F]/10 text-[#F0552F] text-sm font-semibold">💶 1 500 – 2 500 € / mois</span>
            <span className="px-3 py-1.5 rounded-full bg-[#F0552F]/10 text-[#F0552F] text-sm font-semibold">Familles · Expatriés en mission</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="text-[#F0552F] font-bold text-xl font-[family-name:var(--font-heading)]">1 300 – 1 700 €</p>
              <p className="text-[#33251E]/70 text-sm mt-1">Studio</p>
            </div>
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="text-[#F0552F] font-bold text-xl font-[family-name:var(--font-heading)]">1 500 – 2 500 €</p>
              <p className="text-[#33251E]/70 text-sm mt-1">1 chambre</p>
            </div>
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm">
              <p className="text-[#F0552F] font-bold text-xl font-[family-name:var(--font-heading)]">3 000 – 4 000 €</p>
              <p className="text-[#33251E]/70 text-sm mt-1">Grand appart famille</p>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-[#241813]">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold text-white mb-6">Le quartier des familles françaises</h2>
