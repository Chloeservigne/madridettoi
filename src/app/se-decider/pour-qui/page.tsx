      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#171712] leading-tight mb-6">
            Madrid est fait{" "}
            <span className="not-italic font-bold text-[#d6442a]">pour toi&nbsp;?</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-7 shadow-sm">
              <p className="text-[#af3722] font-semibold text-sm uppercase tracking-widest mb-5">
                Profils qui s&apos;épanouissent
              </p>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <span className="text-[#af3722] font-bold mt-0.5">+</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Remote worker ou freelance</span> — Madrid donne la vie sociale et l&apos;énergie que le télétravail a tendance à effacer.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#af3722] font-bold mt-0.5">+</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Quelqu&apos;un qui veut apprendre l&apos;espagnol</span> — immersion totale, langue accessible, et les Madrilènes sont patients avec les apprenants.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#af3722] font-bold mt-0.5">+</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Curieux de culture et de gastronomie</span> — trois musées de rang mondial, une scène culinaire en pleine explosion, une ville en mouvement permanent.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#af3722] font-bold mt-0.5">+</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Quelqu&apos;un qui cherche à ralentir</span> — sans sacrifier les avantages d&apos;une grande capitale européenne. Tout est accessible, mais personne ne court.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#af3722] font-bold mt-0.5">+</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Les extravertis</span> — la culture espagnole est profondément sociale. Les cercles s&apos;ouvrent vite, les soirées s&apos;improvisent, les liens se créent facilement.
                  </p>
                </li>
              </ul>
            </div>
            ...
            {/* Colonne nuances */}
            <div className="bg-white rounded-2xl p-7 shadow-sm">
              <p className="text-[#d6442a] font-semibold text-sm uppercase tracking-widest mb-5">
                Ce qui peut coincer
              </p>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <span className="text-[#d6442a] font-bold mt-0.5">−</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">L&apos;hyper-organisé</span> — l&apos;administration espagnole est lente, imprévisible, parfois kafkaïenne. Si tu as besoin de clarté et de process, prépare-toi à de la frustration.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d6442a] font-bold mt-0.5">−</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Celui qui refuse d&apos;apprendre l&apos;espagnol</span> — tu peux survivre en anglais dans certains quartiers, mais ton cercle social restera limité aux expats. La vraie intégration passe par la langue.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d6442a] font-bold mt-0.5">−</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Celui qui a besoin de la mer</span> — Madrid est à 350 km de la côte. Si la plage fait partie de ton quotidien idéal, c&apos;est un vrai manque à peser sérieusement.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d6442a] font-bold mt-0.5">−</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">Attentes salariales parisiennes</span> — si tu travailles pour une entreprise espagnole locale, les salaires seront sensiblement inférieurs. Compense uniquement si le coût de la vie et la qualité de vie compensent à tes yeux.
                  </p>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d6442a] font-bold mt-0.5">−</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
                    <span className="font-semibold text-[#171712]">L&apos;introverti épuisé</span> — les horaires espagnols impliquent une vie sociale intense, des dîners tardifs, du bruit, de la présence permanente. Ce n&apos;est pas une ville pour se couper du monde.
                  </p>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20 px-6 bg-[#fbfaf6]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="font-semibold text-[#171712] text-lg mb-2">Tu viens en remote ou en freelance</h3>
              <p className="text-[#171712] leading-relaxed text-lg">
                ...
                en tant qu&apos;<Link href="/travailler/freelance" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">autónomo</Link> ou
                gérer sa fiscalité depuis Madrid demande un peu d&apos;organisation au départ.
              </p>
            </div>

            <div>
              <h3 className="font-semibold text-[#171712] text-lg mb-2">Tu viens pour travailler en local</h3>
              <p className="text-[#171712] leading-relaxed text-lg">
            ...
            <div>
              <h3 className="font-semibold text-[#171712] text-lg mb-2">Tu arrives avec des enfants</h3>
              <p className="text-[#171712] leading-relaxed text-lg">
                L&apos;adaptation est possible et beaucoup de familles s&apos;y épanouissent.
                Mais il faut anticiper : la question de la{" "}
                <Link href="/vivre/ecoles" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">
                  scolarisation
                </Link>{" "}
            ...
            <div>
              <h3 className="font-semibold text-[#171712] text-lg mb-2">Tu viens seul(e), pour changer de vie</h3>
              <p className="text-[#171712] leading-relaxed text-lg">
      ...
      <section className="py-20 px-6 bg-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-[#d6442a]">
              <p className="text-[#171712] font-semibold mb-1">Tu apprends l&apos;espagnol, ou tu as l&apos;intention de le faire ?</p>
              <p className="text-[#171712] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-[#d6442a]">
              <p className="text-[#171712] font-semibold mb-1">Tu as une source de revenus qui tient la route ?</p>
              <p className="text-[#171712] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-[#d6442a]">
              <p className="text-[#171712] font-semibold mb-1">Tu as déjà passé du temps à Madrid hors saison touristique ?</p>
              <p className="text-[#171712] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-[#d6442a]">
              <p className="text-[#171712] font-semibold mb-1">Tu viens pour fuir Paris, ou tu viens pour Madrid ?</p>
              <p className="text-[#171712] text-sm leading-relaxed">
