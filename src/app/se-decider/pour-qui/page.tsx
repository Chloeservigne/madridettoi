      ...
      <section className="pt-32 md:pt-40 pb-20 px-6 bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#171712] leading-tight mb-6">
            Madrid est fait{" "}
            <span className="not-italic font-bold text-[#1fa971]">pour toi&nbsp;?</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-7 shadow-sm">
              <p className="text-[#178a5d] font-semibold text-sm uppercase tracking-widest mb-5">
                Profils qui s&apos;épanouissent
              </p>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <span className="text-[#178a5d] font-bold mt-0.5">+</span>
            ...
            {/* Colonne nuances */}
            <div className="bg-white rounded-2xl p-7 shadow-sm">
              <p className="text-[#1fa971] font-semibold text-sm uppercase tracking-widest mb-5">
                Ce qui peut coincer
              </p>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <span className="text-[#1fa971] font-bold mt-0.5">−</span>
                  <p className="text-[#171712] text-sm leading-relaxed">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#171712] leading-relaxed text-lg">
                ...
                en tant qu&apos;<Link href="/travailler/freelance" className="text-[#1fa971] underline underline-offset-2 hover:text-[#178a5d] transition-colors">autónomo</Link> ou
            ...
            <div>
              ...
              <p className="text-[#171712] leading-relaxed text-lg">
                ...
                <Link href="/vivre/ecoles" className="text-[#1fa971] underline underline-offset-2 hover:text-[#178a5d] transition-colors">
                  scolarisation
                </Link>{" "}
      ...
      <section className="py-20 px-6 bg-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-5 shadow-sm border-l-4 border-[#1fa971]">
