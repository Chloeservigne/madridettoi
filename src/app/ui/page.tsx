    ...
    <div className="min-h-screen font-[family-name:var(--font-body)]">
      ...
      <section className="pt-32 md:pt-40 pb-10 px-6 bg-[#171712]">
        <div className="max-w-3xl mx-auto">
          <p className="text-[#d6442a] font-semibold tracking-widest uppercase text-sm mb-4">Madrid & Toi</p>
          <h1 className="font-[family-name:var(--font-display)] text-4xl font-extrabold text-white mb-6">
            Bibliothèque d&apos;éléments
          </h1>
          <p className="text-[#fbe8e4]/60 mb-8">Page non indexée — référence visuelle interne.</p>
          <div className="flex flex-wrap gap-2 text-xs">
            {["Tokens","Hero","Sections","Stat cards","Blockquote","Étapes","Cards","Checklist","Tips","Tableau","Pills","Liens","Tags","Listes","Newsletter","Footer"].map((item) => (
              <a key={item} href={`#${item.toLowerCase().replace(" ","-")}`} className="px-3 py-1.5 rounded-full bg-white/10 text-[#fbe8e4]/70 hover:bg-white/20 transition-colors">
                {item}
              </a>
            ))}
          </div>
      ...
      <section id="tokens" className="py-16 px-6 bg-[#fbfaf6] border-b-4 border-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs font-bold tracking-[0.2em] uppercase mb-3 text-[#af3722]">
          ...
          <h2 className="font-[family-name:var(--font-display)] text-5xl sm:text-6xl leading-[0.9] font-extrabold mb-10 text-[#171712]">
            Sans galérer, <span className="text-[#d6442a]">vraiment</span>
          </h2>
          <p className="text-xs font-bold tracking-[0.2em] uppercase mb-3 text-[#af3722]">
          ...
          <div className="flex flex-wrap items-end gap-6 mb-10">
            ...
            <span className="font-[family-name:var(--font-body)] px-6 py-3 rounded-full text-white font-bold text-sm bg-[#d6442a]">
              Bouton CTA
            </span>
            <span className="font-[family-name:var(--font-body)] px-4 py-2 rounded-full text-sm font-bold bg-[#fbe8e4] text-[#af3722]">
              Badge secondaire
            </span>
          </div>
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
            {[
              ...
              { hex: "#d6442a", label: "Vert" },
              { hex: "#af3722", label: "Vert profond" },
              { hex: "#fbe8e4", label: "Vert pâle" },
            ].map((sw) => (
              <div key={sw.hex}>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-4">
            ...
            <div className="bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9] rounded-2xl p-8">
              <Link href="#" className="inline-flex items-center gap-2 text-[#d6442a] text-sm font-semibold mb-6 hover:gap-3 transition-all">
                ← Retour à la section parent
              </Link>
              <p className="text-[#af3722] font-semibold tracking-widest uppercase text-sm mb-3">Label de catégorie</p>
              <h1 className="font-[family-name:var(--font-display)] text-4xl sm:text-5xl font-extrabold text-[#171712] leading-tight mb-4">
                Titre principal de la page{" "}
                <span className="not-italic font-bold text-[#d6442a]">avec accent terracotta</span>
              </h1>
          ...
          <div>
            ...
            <div className="bg-gradient-to-b from-[#fbfaf6] to-[#f2f0e9] rounded-2xl p-8">
              <h2 className="font-[family-name:var(--font-body)] text-3xl font-bold text-[#171712] mb-4">
                Titre avec{" "}
                <span className="not-italic font-bold text-[#d6442a]">tags dessous</span>
              </h2>
              <p className="text-[#171712] mb-4">Description courte.</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">Tag 1</span>
                <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">Tag 2</span>
                <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">Tag 3</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ─── SECTIONS ─── */}
      <section id="sections" className="py-16 px-6 bg-[#f2f0e9] border-b-4 border-[#fbe8e4]">
        <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {["2–6 sem.", "15–30 min", "Sept–Oct", "J+0"].map((v) => (
                  <div key={v} className="bg-white rounded-2xl p-5 text-center shadow-sm">
                    <p className="font-[family-name:var(--font-display)] text-2xl font-extrabold text-[#d6442a] mb-2">{v}</p>
      ...
      <section id="blockquote" className="py-16 px-6 bg-[#171712] border-b-4 border-[#f2f0e9]">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-mono text-[#d6442a]/40 uppercase tracking-widest mb-6">04 — Blockquote / Citation</p>
          <p className="text-[#fbe8e4]/50 text-sm mb-8">Toujours sur fond sombre <code className="bg-white/10 px-1 rounded text-xs">bg-[#171712]</code>. Bordure or, texte or, italic Playfair.</p>

          <blockquote className="border-l-4 border-[#d6442a] pl-6 mb-8">
          ...
          <p className="text-[#fbe8e4]/50 text-sm mb-4">La section sombre peut contenir d&apos;autres éléments avant la blockquote :</p>
          <div className="bg-white/10 rounded-2xl p-5 mb-6">
            <p className="text-[#d6442a] font-semibold text-sm uppercase tracking-widest mb-2">Titre d&apos;un bloc interne</p>
            <p className="text-[#fbe8e4]/80 text-sm leading-relaxed">Contenu d&apos;un bloc sur fond sombre. Texte en <code className="bg-white/10 px-1 rounded text-xs">text-[#fbe8e4]/80</code>, titre en <code className="bg-white/10 px-1 rounded text-xs">text-[#d6442a]</code>.</p>
          </div>
      ...
      {/* ─── ÉTAPES NUMÉROTÉES ─── */}
      <section id="étapes" className="py-16 px-6 bg-[#f2f0e9] border-b-4 border-[#fbe8e4]">
        <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={step.n} className="flex gap-5">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#d6442a] flex items-center justify-center text-white font-bold text-sm">{step.n}</div>
                  <div>
          ...
          <div className="bg-[#171712] rounded-2xl p-8">
            <p className="text-xs text-[#fbe8e4]/30 mb-6">Variante fond sombre (ex: /papiers/nie)</p>
            <div className="space-y-6">
              {[
                { n: "1", title: "Première étape", body: "Texte en text-[#fbe8e4]/80. Titre en text-white via font-[family-name:var(--font-body)]." },
                ...
                <div key={step.n} className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-[#fbe8e4]/80 leading-relaxed text-sm">{step.body}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white rounded-2xl p-5 shadow-sm">
                  <p className="text-[#d6442a] font-semibold uppercase tracking-widest text-sm mb-2">Label catégorie</p>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm">
                  <p className="text-[#d6442a] font-semibold uppercase tracking-widest text-sm mb-2">Autre catégorie</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <Link href="#" className="group p-8 rounded-3xl bg-white shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-200">
                  ...
                  <h2 className="font-[family-name:var(--font-body)] text-xl font-bold text-[#171712] mb-3 group-hover:text-[#d6442a] transition-colors">Titre du guide</h2>
      ...
      {/* ─── CHECKLIST & TIPS ─── */}
      <section id="checklist" className="py-16 px-6 bg-[#f2f0e9] border-b-4 border-[#fbe8e4]">
        <div className="max-w-3xl mx-auto">
            ...
            <div>
              ...
              <div className="bg-white rounded-3xl shadow-md overflow-hidden">
                <div className="px-6 py-4 bg-[#171712]">
                  <p className="text-[#d6442a] font-semibold">💡 Titre des astuces</p>
                </div>
                <div className="divide-y divide-[#f2f0e9]">
                  {[
      ...
      {/* ─── PILLS ─── */}
      <section id="pills" className="py-16 px-6 bg-[#f2f0e9] border-b-4 border-[#fbe8e4]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-[#fbfaf6] rounded-2xl p-8">
            ...
            <div className="flex flex-wrap gap-3">
              {["Lien connexe 1","Lien connexe 2","Lien connexe 3","Lien connexe 4"].map((l) => (
                <Link key={l} href="#" className="px-4 py-2 rounded-full bg-white shadow-md text-[#171712] text-sm hover:text-[#d6442a] transition-colors">{l}</Link>
              ))}
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-[#fbfaf6] rounded-2xl p-6">
              ...
              <p className="text-[#171712] text-lg">
                ...
                <Link href="#" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">NIE</Link>{" "}
                avant de signer ton bail. Consulte aussi la page sur la{" "}
                <Link href="#" className="text-[#d6442a] underline underline-offset-2 hover:text-[#af3722] transition-colors">Seguridad Social</Link>.
              </p>
            </div>
            <div className="bg-[#171712] rounded-2xl p-6">
              <p className="text-xs text-[#fbe8e4]/30 mb-3">Sur fond sombre — or souligné</p>
              <p className="text-[#fbe8e4]/80 text-lg">
                Retrouve les quartiers comme{" "}
                <Link href="#" className="text-[#d6442a] underline underline-offset-2 hover:opacity-80 transition-opacity">Malasaña</Link>{" "}
                ou{" "}
                <Link href="#" className="text-[#d6442a] underline underline-offset-2 hover:opacity-80 transition-opacity">Chueca</Link>{" "}
            ...
            <div className="bg-[#f2f0e9] rounded-2xl p-6">
              ...
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#d6442a] text-white text-sm font-semibold hover:bg-[#af3722] transition-colors">
                Lien externe officiel ↗
              </a>
              <span className="mx-3 text-[#171712]/30">ou</span>
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 border border-[#d6442a]/30 text-[#d6442a] text-sm font-semibold hover:bg-white transition-colors">
                Lien secondaire ↗
              </a>
            </div>
          </div>
      ...
      {/* ─── TAGS ─── */}
      <section id="tags" className="py-16 px-6 bg-[#f2f0e9] border-b-4 border-[#fbe8e4]">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-mono text-[#171712]/40 uppercase tracking-widest mb-6">11 — Tags & badges</p>

          <div className="flex flex-wrap gap-3">
            <span className="px-3 py-1.5 rounded-full bg-[#d6442a]/10 text-[#d6442a] text-sm font-semibold">Tag terracotta</span>
            <span className="px-3 py-1.5 rounded-full bg-[#af3722]/10 text-[#af3722] text-sm font-semibold">Tag vert</span>
            <span className="text-xs bg-[#d6442a]/20 text-[#d6442a] px-3 py-1 rounded-full font-semibold">Bientôt</span>
      ...
      <section id="footer" className="py-2 px-6 bg-[#171712]">
        <p className="text-xs font-mono text-[#fbe8e4]/20 uppercase tracking-widest text-center py-4 mb-0">14 — Footer (identique sur toutes les pages)</p>
      </section>
